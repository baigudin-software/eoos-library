...
inline char_t CharTrait<char_t>::getTerminator()
{
    return '\0';
}

template <typename I>
char_t CharTrait<char_t>::convertDigitToChar(I val)
{
    char_t ch( ' ' );
    switch(val)
    {
...
inline char_t CharTrait<char_t>::getMinusSign()
{
    return '-';
}

inline wchar_t CharTrait<wchar_t>::getTerminator()
{
    return L'\0';
}

template <typename I>
wchar_t CharTrait<wchar_t>::convertDigitToChar(I val)
{
...
inline char16_t CharTrait<char16_t>::getTerminator()
{
    return u'\0';
}

template <typename I>
char16_t CharTrait<char16_t>::convertDigitToChar(I val)
{
    char16_t ch( u' ' );
    switch(val)
    {
...
template <typename I>
char32_t CharTrait<char32_t>::convertDigitToChar(I val)
{
    char32_t ch( U' ' );
    switch(val)
    {
...
inline char8_t CharTrait<char8_t>::getTerminator()
{
    return u8'\0';
}

template <typename I>
char8_t CharTrait<char8_t>::convertDigitToChar(I val)
{
    char8_t ch( u8' ' );
    switch(val)
    {
